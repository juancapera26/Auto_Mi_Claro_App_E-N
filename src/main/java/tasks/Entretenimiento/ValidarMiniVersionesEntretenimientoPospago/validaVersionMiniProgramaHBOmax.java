...
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_CLARO_HBO_MAX_CONSTANT;
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_CLARO_MUSICA_CONSTANT;

public class validaVersionMiniProgramaHBOmax implements Task {

    private static final User user = TestDataProvider.getRealUser();

    private static final String paso =
            "Esperar desaparición del texto 'Espera un momento'";

    private static final String paso2 =
            "Ingresar al menú de tres puntos y seleccionar 'Acerca de'";

    private static final String paso3 =
            "Validar versión de mini app Claro HBO Max";

    private static final String paso4 =
            "Seleccionar la cuenta hogar y ver detalle";
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(HBO_MAX),
                ValidarTextoQueContengaX.elTextoContiene(MINI_VERSION_CLARO_HBO_MAX_CONSTANT)
        );
    ...
    public static Performable validar() {
        return instrumented(validaVersionMiniProgramaHBOmax.class);
    }
}