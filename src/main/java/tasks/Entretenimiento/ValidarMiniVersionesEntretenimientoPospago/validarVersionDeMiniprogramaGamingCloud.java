...
import tasks.Entretenimiento.SeleccionarGamingCloud;
...
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_AMAZON_PRIME_CONSTANT;
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_GAMING_CLOUD_PRIME_CONSTANT;

public class validarVersionDeMiniprogramaGamingCloud implements Task {
    ...
    private static final String paso3 = "Validar versión de mini app Claro Gaming Cloud";
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(GAMING_CLOUD),
                VerificarVersionModulo.conLaEsperada(MINI_VERSION_GAMING_CLOUD_PRIME_CONSTANT));
    ...
    public static Performable validar() {
        return instrumented(validarVersionDeMiniprogramaGamingCloud.class);
    }
}
