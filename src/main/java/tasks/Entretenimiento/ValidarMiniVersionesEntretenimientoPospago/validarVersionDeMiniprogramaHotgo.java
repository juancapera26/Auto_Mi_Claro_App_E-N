...
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_DISNEY_CONSTANT;
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_HOTGO_CONSTANT;

public class validarVersionDeMiniprogramaHotgo implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                VerificarVersionModulo.conLaEsperada(MINI_VERSION_HOTGO_CONSTANT));
    ...
    public static Performable validar() {
        return instrumented(validarVersionDeMiniprogramaHotgo.class);
    }
}
