...
import tasks.Entretenimiento.ValidarRedireccionWinPlay;
...
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_HOTGO_CONSTANT;
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_WIN_PLAY_CONSTANT;

public class validarVersionDeMiniprogramaWinPlay implements Task {
    ...
    private static final String paso3 = "Validar versión de mini app Win Play";
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                VerificarVersionModulo.conLaEsperada(MINI_VERSION_WIN_PLAY_CONSTANT));
    ...
    public static Performable validar() {
        return instrumented(validarVersionDeMiniprogramaWinPlay.class);
    }
}
