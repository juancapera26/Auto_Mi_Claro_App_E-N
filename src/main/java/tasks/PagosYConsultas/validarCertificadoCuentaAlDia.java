...
import tasks.PagosYConsultas.ConfiguracionControlRemoto.validarConfiguracionDelDecodificador;
import tasks.PagosYConsultas.DetalleDeTuPlan.DetalleTuPlan;
...
import static utils.Constants.DESCARGA_TELEFONO_VIRTUAL;
import static utils.ConstantsMiniVersiones.Versiones.MINI_VERSION_DETALLE_DE_TU_PLAN_CONSTANT;

public class validarCertificadoCuentaAlDia implements Task {
    ...
    public static Performable validar() {
        return instrumented(validarCertificadoCuentaAlDia.class);
    }
}
