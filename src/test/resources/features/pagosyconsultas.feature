Feature: Ingresar al modulo pagos y consultas
 ...
 Scenario: Ingresar a devolucion de equipo
  ...
  @PC006
  Scenario: Ingresar a Adquirir producto
    Given EL USUARIO ABRE LA SUPER APP
    When REALIZA EL INGRESO
    And INGRESA AL MENU PAGOS Y CONSULTAS
  ...
  @PC007
  Scenario: Ingresar a Configuracion control remoto ,comprar control remoto
    Given EL USUARIO ABRE LA SUPER APP
    When REALIZA EL INGRESO
    And INGRESA AL MENU PAGOS Y CONSULTAS
  ...
  @PC008
  Scenario: Ingresar a Configuracion control remoto
    Given EL USUARIO ABRE LA SUPER APP
    When REALIZA EL INGRESO
    And INGRESA AL MENU PAGOS Y CONSULTAS
    And INGRESAR A CONFIGURACION CONTROL REMOTO
  ...
  @PC009
  Scenario: Ingresar a Configuracion control remoto ,Configuración con el decodificador
    Given EL USUARIO ABRE LA SUPER APP
    When REALIZA EL INGRESO
    And INGRESA AL MENU PAGOS Y CONSULTAS
    And INGRESAR A CONFIGURACION CONTROL REMOTO
